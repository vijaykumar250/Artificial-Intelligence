...
data = pd.read_excel('E:\ArtificialIntelligence&MachineLearning\MachineLearning\Day3\linearxl.xlsx')
...
#legendd
# Ploting Line
#plt.Scatter(feature_train, feature_test, label='feature train and feature test bo')
#plt.plot(target_train, target_test, color='#58b970', label='target train and target test go')
#plt.plot(target_prediction, color='#58b970', label='target train and target test go')
