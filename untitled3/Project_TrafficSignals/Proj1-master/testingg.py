...
def fn_make_img(count=10000, path="data"):
    ...
    with open(path + sep + "tracking_master.csv", mode="a") as f:
        ...
        for i in range(0,count):
            ...
            del draw
            # save image
            print(new_img.save (path + sep + str(i)+".png"))
...
# ==================================================================
# main
# it will load all images in data folder if u increase loop it wiil continue images by there onwards,it wiil show none only u have to increse loop
fn_make_img(count=10000)
load_data(total_row=10000)