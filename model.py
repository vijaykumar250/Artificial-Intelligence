...
with open("E:\Machine Learning\color_sep\Models\Model1_"+timestr+".yaml", "w") as yaml_file:
...
with open("E:\Machine Learning\color_sep\Models\Model2_"+timestr+".yaml", "w") as yaml_file:
    yaml_file.write(model_yaml)
# serialize weights to HDF5
